...
We'll implement a Singly Linked List using the C language. The complete code for this post can be found [here](https://github.com/w11wo/blog/blob/master/_posts/code/singlyLinkedList.c).
